...
" Cursor
call s:hl("Cursor",         { "fg": s:black, "bg": s:yellow })
...
call s:hl("CursorLine",     { "bg": s:black })
...
" Misc
call s:hl("MatchParen",     { "bg": s:blue, "fg": s:white })
call s:hl("QuickFixLine",   { "bg": s:gray, "style": "bold" })
call s:hl("SpecialKey",     { "fg": s:darkgray })
